...
//        std::cout<<"reshape_DET_OUT_C"<<inputs[0].d[0]<<std::endl;
//        std::cout<<"reshape_DET_OUT_H"<<inputs[0].d[1]<<std::endl;
//        std::cout<<"reshape_DET_OUT_W"<<inputs[0].d[2]<<std::endl;
//        std::cout<<"c"<<OutC<<std::endl;
//        std::cout<<"h"<<inputs[0].d[0] * inputs[0].d[1] / OutC<<std::endl;
//        std::cout<<"w"<<inputs[0].d[2]<<std::endl;
...
//        std::cout<<"flatten enqueue:"<<_size<<std::endl;
//        std::cout<<"inputs0_0: "<<inputs[0].d[0]<<std::endl;
//        std::cout<<"inputs0_1: "<<inputs[0].d[1]<<std::endl;
//        std::cout<<"inputs0_2: "<<inputs[0].d[2]<<std::endl;
//        std::cout<<"fl_size: "<<_size<<std::endl;
        return DimsCHW(_size, 1, 1);
    }
